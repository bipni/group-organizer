        ...
        <div className="registration">
                ...
                <div>
                    <form>
                            ...
                            <input className="reg-input" type="text" name="name" placeholder="Name"/>

                            <label className="reg-label">Username</label>
                            <input className="reg-input" type="text" name="username" placeholder="Username"/>

                            <label className="reg-label">Email</label>
                            <input className="reg-input" type="text" name="email" placeholder="Email"/>

                            <label className="reg-label">Mobile Number</label>
                            <input className="reg-input" type="text" name="mobilenumber" placeholder="Mobile Number"/>
